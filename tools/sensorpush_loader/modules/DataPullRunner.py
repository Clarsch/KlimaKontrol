...
class DataPullRunner:
    ...
    def __init__(self, queue: asyncio.Queue, auth = None, base_url = 'https://api.sensorpush.com'):
        ...
        self.observation_uploader = ObservationUploader()
    ...
    async def _pull_data(self):
        ...
        max_records = 20#000 # * number_of_sensors
            ...
            for observation in sensor[1]:
                ...
                if 'observed' in observation: 
                    ...
                    if not id_hash in self.observations:
                        ...
                        await self.async_queue.put(observation)
                        self.observation_uploader.post_data_observation(observation)
